...
db1 = Database("chat", path_to_json_file="/scratch_chat/chat_db.json", save_interval=5)
db2 = Database("history", path_to_json_file="/scratch_chat/chat_history_db.json", save_interval=5)
